    ...
    <nav className="bg-gray-900 p-4 text-white fixed w-full z-10 top-0 shadow-lg">
      <div className="container mx-auto flex justify-between items-center">
        <div className="text-3xl font-extrabold">
          <a href="/">Preetham Jayam</a>
        </div>
        <div className='flex space-x-6'>
    
    <a href="https://www.linkedin.com/in/naga-preetham-jayam-941998229" target='_blank' rel='noopener noreferrer' className='footer-icon text-blue-700'>
        <AiFillLinkedin className='text-3xl text-blue-700' />
    </a>
    <a href="https://github.com/Preetham-jayam" target='_blank' rel='noopener noreferrer' className='footer-icon text-gray-800'>
