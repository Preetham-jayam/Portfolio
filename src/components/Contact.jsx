...
const Contact = () => {
	 const EMAIL_JS_SERVICE_ID = 'service_nsfc7ne';
	const EMAIL_JS_TEMPLATE_ID = 'template_lxl6ehi';
	const EMAIL_JS_PUBLIC_KEY = 'mffQgT_TJWA5A1TGE';
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: username,
          to_name: 'Preetham Jayam',
          reply_to: user_email,
          to_email: 'preethamjayam2004@gmail.com',
